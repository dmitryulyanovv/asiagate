  ...
  return (
    <footer className="relative border-t border-white/[0.06] bg-[#0A0A0A]">
      ...
      <div className="container py-16 lg:py-20">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.4fr_0.8fr_1fr]">
          <div>
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed text-[#ADADAD]">
              ...
              <ul className="mt-5 flex flex-col gap-3.5">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-[#ADADAD] transition-colors duration-200 hover:text-[#00D4A5]"
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div>
            ...
            <ul className="mt-5 flex flex-col gap-4">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+74952680202" className="text-sm text-[#E5E5E5] hover:text-white">
                  +7 495 268-02-02
                </a>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a
                  href="https://www.google.com/maps?q=55.754203,37.556388"
                  target="_blank"
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-8 sm:flex-row">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            <a href="/privacy-policy" className="text-xs text-[#666666] transition-colors hover:text-white">
              Политика конфиденциальности
            </a>
            <a href="/personal-data" className="text-xs text-[#666666] transition-colors hover:text-white">
              Обработка персональных данных
            </a>
            <a href="/public-offer" className="text-xs text-[#666666] transition-colors hover:text-white">
              Публичная оферта
            </a>
          </div>
        </div>
