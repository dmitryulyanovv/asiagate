...
const PHOTOS = [
  {
    ...
    alt: "Складская консолидация грузов перед отправкой",
    caption: "Консолидация и упаковка на складе в Гуанчжоу",
    span: "lg:col-span-2 lg:row-span-2",
  },
  {
    src: "https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=900&q=80",
    alt: "Стеллажи современного склада",
    caption: "Собственные складские мощности",
    span: "",
  },
  {
      ...
      <div className="container">
        ...
        >
          ...
          <h2 className="mt-4 text-balance font-display text-4xl font-bold text-white sm:text-5xl">
            Реальные процессы, а не обещания
          </h2>
        </motion.div>

        <div className="mt-14 grid grid-cols-1 gap-4 lg:grid-flow-dense lg:auto-rows-[220px] lg:grid-cols-3">
          {PHOTOS.map((photo, i) => (
            <motion.div
              key={photo.src}
