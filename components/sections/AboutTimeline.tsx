...
const MILESTONES = [
  ...
  { year: "2026", title: "Сегодня", text: "Более 12 000 успешных поставок. Расширение географии и услуг. Постоянное развитие и внедрение новых решений для клиентов." },
];
            ...
            {MILESTONES.map((m, i) => (
              ...
              >
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-[#ADADAD]">{m.text}</p>
                </div>
