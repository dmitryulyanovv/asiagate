...
import { PhoneOff, HandCoins, CalendarCheck2, Sparkles, Users, ShieldCheck, Laptop, TrendingUp } from "lucide-react";
...
const HIGHLIGHTS = [
  ...
  {
    icon: Laptop,
    title: "Нужен только смартфон",
    description: "Никакого специального оборудования или установки программ — всё уже готово.",
    span: "",
  },
  {
    icon: TrendingUp,
    title: "Рост внутри команды",
    description: "Лучшие операторы становятся наставниками и старшими специалистами поддержки.",
    span: "",
  },
  {
    icon: ShieldCheck,
    title: "Официальный ГПХ + НПД",
    description: "Прозрачное оформление на НПД — поможем зарегистрироваться. Это может быть самозанятость или ИП на НПД — оба варианта без страховых взносов. Поможем выбрать и оформить всё быстро.",
    span: "lg:col-span-2",
  },
];
      ...
      <div className="container">
        ...
        >
          <span className="text-sm font-semibold uppercase tracking-widest text-[#00D4A5]">
            Почему сотрудники остаются с нами
          </span>
        ...
        <div className="mt-16 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {HIGHLIGHTS.map((h, i) => (
            ...
            >
              ...
              <p className="relative mt-2.5 max-w-sm text-sm leading-relaxed text-[#ADADAD]">
                {h.description}
              </p>
            </motion.div>
          ))}
