...
const FAQ = [
  ...
  },
  {
    ...
    a: "Оформление — через налог на профессиональный доход (НПД). Это может быть самозанятость или ИП на НПД — оба варианта без страховых взносов. Поможем выбрать и оформить всё быстро.",
  },
  {
