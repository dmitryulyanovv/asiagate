...
const CONTACT_INFO = [
  { icon: Phone, title: "Телефон", value: "8 800 123-45-67", href: "tel:+78001234567" },
  { icon: Mail, title: "Email", value: "info@asiagate.ru", href: "mailto:info@asiagate.ru" },
  { icon: MapPin, title: "Офис", value: "Москва, Пресненская наб., 12", href: undefined },
            ...
            {CONTACT_INFO.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-medium text-[#A3A3A3]">{c.title}</p>
              ...
              {status === "success" ? (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div>
                      <label className="mb-2 block text-xs font-medium text-[#A3A3A3]">Имя</label>
                      <Input required name="name" placeholder="Ваше имя" />
                    </div>
                    <div>
                      <label className="mb-2 block text-xs font-medium text-[#A3A3A3]">Телефон</label>
                      <Input required type="tel" name="phone" placeholder="+7 (___) ___-__-__" />
                    </div>
                  </div>
                  <div>
                    <label className="mb-2 block text-xs font-medium text-[#A3A3A3]">Email</label>
                    <Input type="email" name="email" placeholder="you@company.ru" />
                  </div>
                  <div>
                    <label className="mb-2 block text-xs font-medium text-[#A3A3A3]">Сообщение</label>
                    <Textarea
                      required
                      name="message"
