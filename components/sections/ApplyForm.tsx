      ...
      <div className="container relative">
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          ...
          >
            ...
            <p className="mt-5 max-w-md text-lg leading-relaxed text-[#ADADAD]">
          ...
          >
            <AnimatePresence mode="wait">
              {status === "success" ? (
                ...
                >
                  <div>
                    <label className="mb-2 flex items-center gap-2 text-xs font-medium text-[#ADADAD]">
                      <User className="h-3.5 w-3.5" /> Как к вам обращаться
                    </label>
                    <Input required name="name" placeholder="Ваше имя" />
                  </div>

                  <div className="flex items-center gap-2.5 rounded-xl border border-[#00D4A5]/20 bg-[#00D4A5]/[0.06] px-4 py-3">
                    <span className="h-2 w-2 shrink-0 rounded-full bg-[#00D4A5]" />
                    <span className="text-xs text-[#E5E5E5]">
                      Вы откликаетесь на вакансию: <b className="font-semibold text-white">Оператор чата поддержки</b>
                    </span>
                  </div>
                  ...
                  <div>
                    <label className="mb-2 block text-xs font-medium text-[#ADADAD]">
                        ...
                        <button
                          ...
                          className={`rounded-full border px-4 py-2 text-xs font-medium transition-all duration-200 ${
                            slot === s
                              ...
                              : "border-white/10 text-[#ADADAD] hover:border-white/25"
                          }`}
                        >
                          {s}
                        </button>
                  ...
                  <p className="text-center text-[11px] leading-relaxed text-[#666666]">
                    ...
                    <a href="/personal-data" className="underline decoration-white/20 underline-offset-2 hover:text-[#ADADAD]">
