      ...
      <div className="container">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <p className="mt-6 text-base leading-relaxed text-[#ADADAD]">
            ...
            <p className="mt-4 text-base leading-relaxed text-[#ADADAD]">
          ...
          >
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-[#161616] p-8">
              ...
              <p className="mt-2.5 text-sm leading-relaxed text-[#ADADAD]">
