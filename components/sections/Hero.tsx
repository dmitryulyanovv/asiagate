    ...
    >
      ...
      <motion.div style={{ opacity: contentOpacity }} className="container relative z-10">
        ...
        >
          ...
          <motion.p
            variants={item}
            className="mt-7 max-w-2xl text-balance text-lg leading-relaxed text-[#ADADAD] sm:text-xl"
          >
          ...
          >
            {badges.map(({ icon: Icon, label }) => (
              <div key={label} className="flex items-center gap-2 text-sm text-[#ADADAD]">
